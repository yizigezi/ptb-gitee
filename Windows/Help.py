...
print("修改于",edittime)
print("")
print("1.ASCII转换工具 2.计算器 3.sys.ver工具 4.BootLoader 5.PyKernel 6.PyMusic")
...
if help == 1:
    ...
    print("sys.ver，0.1Beta")
elif help == 4:
    print("Bootloader")
    print("现在看上去除了显示版本号、启动kernel之外似乎没有其他什么用....不过后期会有更多功能。")
    print("此程序待完善")
    ...
    print("PyMusic")
    print("PyMusicPlayer:您可以在这里播放音乐，现支持*.mp3，可通过在PyKernel输入Music打开")
    print("您也可以输入歌名下载音乐，音乐来自网易云音乐。可在PyMusicPlayer中点击  下载歌曲  打开")
    print("PyMusic 0.1 Fantasia")
